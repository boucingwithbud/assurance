...
class PermisConduireRectoVerso(BaseModel):

    nom: str = Field(default=None, description="Nom de famille de la personne titulaire du permis de conduire")
    prenom: str = Field(default=None, description="Prénom de la personne titulaire du permis de conduire")
    date_naissance: date = Field(default=None, description="Date de naissance de la personne titulaire du permis de conduire")
    adresse: str = Field(default=None, description="Adresse de la personne titulaire du permis de conduire")
    lieu_naissance: str = Field(default=None, description="Lieu de naissance de la personne titulaire du permis de conduire")
    date_delivrance: date = Field(default=None, description="Date de délivrance du permis de conduire au format YYYY-MM-DD")
    ...
    cat_a_validite: date = Field(default=None, description="Date de validité de la catégorie A au format YYYY-MM-DD")
    cat_b_validite: date = Field(default=None, description="Date de validité de la catégorie B au format YYYY-MM-DD")    
    cat_d_validite: date = Field(default=None, description="Date de validité de la catégorie D au format YYYY-MM-DD")
    cat_e_validite: date = Field(default=None, description="Date de validité de la catégorie E au format YYYY-MM-DD")
    cat_a_expiration: date = Field(default=None, description="Date d'expiration de la catégorie A au format YYYY-MM-DD")
    cat_b_expiration: date = Field(default=None, description="Date d'expiration de la catégorie B au format YYYY-MM-DD")
    cat_c_expiration: date = Field(default=None, description="Date d'expiration de la catégorie C au format YYYY-MM-DD")
    cat_d_expiration: date = Field(default=None, description="Date d'expiration de  la catégorie D au format YYYY-MM-DD")
    cat_e_expiration: date = Field(default=None, description="Date d'expiration de la catégorie E au format YYYY-MM-DD")    
    groupe_sanguin: str = Field(default=None, description="Groupe sanguin de la personne titulaire du permis de conduire, souvent indiqué au verso du permis")
    document_identite: str = Field(default=None, description= "Identifiant commancant par CNI-")
...
class CarteGriseRectoVerso(BaseModel):
    ...
    date_mise_circulation: date = Field(default=None, description="Date de première mise en circulation du véhicule au format YYYY-MM-DD")
    date_edition_carte_grise: date = Field(default=None, description="Date d'édition de la carte grise au format YYYY-MM-DD")
    ...
    nombre_essieux: int = Field(default=None, description="Nombre d'essieux du véhicule")
    places_assises: int = Field(default=None, description="Nombre de places assises du véhicule")
    puissance_fiscale: int = Field(default=None, description="Puissance fiscale du véhicule en CV")
    cylindree_cc: int = Field(default=None, description="Cylindrée du véhicule en centimètres cubes (CC)")
    masse_vehicule: int = Field(default=None, description=" PTAC ou poids total autorisé en charge du véhicule en kg")
    pv: int = Field(default=None, description="Poids à vide du véhicule en kg")
    cu: int = Field(default=None, description="Charge utile du véhicule en kg")
    numero_vin_chassis: str = Field(default=None, description="Numéro VIN ou numéro de châssis du véhicule")
    societe_credit: str = Field(default=None, description="Société de crédit si le véhicule est acheté à crédit")
    numero_moteur: str = Field(default=None, description="Numéro de moteur du véhicule")
    type_technique: str = Field(default=None, description="Type technique du véhicule")
    numero_immatriculation_precedent: str = Field(default=None, description="Numéro d'immatriculation précédente du véhicule s'il y a lieu")



class BulletinAdhesion(BaseModel):

    nom: str = Field(default=None, description="Nom de famille de l'adhérent")
    societe_adherente: str = Field(default=None, description="Nom de la société à laquelle l'adhérent est affilié")
    adresse: str = Field(default=None, description="Adresse complète de l'adhérent")
    numero_telephone: str = Field(default=None, description="Numéro de téléphone de l'adhérent")
    assure_date_entree_entreprise: str = Field(default=None, description="Date d'entrée de l'adhérent dans l'entreprise au format YYYY-MM-DD")
    assure_date_naissance: date = Field(default=None, description="Date de naissance de l'adhérent au format YYYY-MM-DD")
    assure_lieu_naissance: str = Field(default=None, description="Lieu de naissance de l'adhérent")
    conjoint_date_naissance: date = Field(default=None, description="Date de naissance du conjoint de l'adhérent au format YYYY-MM-DD")
    assure_profession: str = Field(default=None, description="Profession de l'adhérent")
    conjoint_profession: str = Field(default=None, description="Profession du conjoint de l'adhérent")
    premier_enfant_profession: str = Field(default=None, description="Profession de l'adhérent")
    second_enfant_profession: str = Field(default=None, description="Profession du conjoint de l'adhérent")
    troisieme_enfant_profession: str = Field(default=None, description="Profession de l'adhérent")
    quatrieme_enfant_profession: str = Field(default=None, description="Profession du conjoint de l'adhérent")
    cinquieme_enfant_profession: str = Field(default=None, description="Profession de l'adhérent")
    assure_sport: str = Field(default=None, description="Sport pratiqué par l'adhérent")
    conjoint_sport: str = Field(default=None, description="Sport pratiqué par le conjoint de l'adhérent")
    premier_enfant_sport: str = Field(default=None, description="Sport pratiqué par le premier enfant de l'adhérent")
    second_enfant_sport: str = Field(default=None, description="Sport pratiqué par le second enfant de l'adhérent")
    troisieme_enfant_sport: str = Field(default=None, description="Sport pratiqué par le troisième enfant de l'adhérent")
    quatrieme_enfant_sport: str = Field(default=None, description="Sport pratiqué par le quatrième enfant de l'adhérent")
    cinquieme_enfant_sport: str = Field(default=None, description="Sport pratiqué par le cinquième enfant de l'adhérent")
    assure_poids: int = Field(default=None, description="Poids de l'adhérent en kg")
    conjoint_poids: int = Field(default=None, description="Poids du conjoint de l'adhérent en kg")
    premier_enfant_poids: int = Field(default=None, description="Poids du premier enfant de l'adhérent en kg")
    second_enfant_poids: int = Field(default=None, description="Poids du second enfant de l'adhérent en kg")
    troisieme_enfant_poids: int = Field(default=None, description="Poids du troisième enfant de l'adhérent en kg")
    quatrieme_enfant_poids: int = Field(default=None, description="Poids du quatrième enfant de l'adhérent en kg")
    cinquieme_enfant_poids: int = Field(default=None, description="Poids du cinquième enfant de l'adhérent en kg")
    assure_taille: int = Field(default=None, description="Taille de l'adhérent en cm")
    conjoint_taille: int = Field(default=None, description="Taille du conjoint de l'adhérent en cm")
    premier_enfant_taille: int = Field(default=None, description="Taille du premier enfant de l'adhérent en cm")
    second_enfant_taille: int = Field   (default=None, description="Taille du second enfant de l'adhérent en cm")
    troisieme_enfant_taille: int = Field(default=None, description="Taille du troisième enfant de l'adhérent en cm")
    quatrieme_enfant_taille: int = Field(default=None, description="Taille du quatrième enfant de l'adhérent en cm")
    cinquieme_enfant_taille: int = Field(default=None, description="Taille du cinquième enfant de l'adhérent en cm")
